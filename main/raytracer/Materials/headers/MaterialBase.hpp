...
#include "../../Textures/headers/TextureBase.hpp"
...
namespace RT
{
	...
	public:
		...
		void AssingTexture(const std::shared_ptr<RT::Texture::TextureBase> &Texture);

	public:
		inline static int m_max_reflectionsRays;
		inline static int m_reflectionRayCount;
		// LIst of textures to this material
		std::vector<std::shared_ptr<RT::Texture::TextureBase>> m_texttures;
